...
Unbound Diffusion Approximation as presented in Orio & Soudry, 2012
USAGE:
...
def simulate(nsim=30,Tstop=15,dt=0.005,
    ...
    while p<points:
        ...
        # imaginary roots
        ma=abs(m)
        R=np.random.normal(0,1,(10,nsim))*np.sqrt((dt/NNa)*np.array([3*am*ma[0,]+bm*ma[1,],
                           2*am*ma[1,]+2*bm*ma[2,],am*ma[2,]+3*bm*ma[3,],
                           ah*ma[0,]+bh*ma[4,],ah*ma[1,]+bh*ma[5,],
                           ah*ma[2,]+bh*ma[6,],ah*ma[3,]+bh*ma[7,],3*am*ma[4,]+bm*ma[5,],
                           2*am*ma[5,]+2*bm*ma[6,],am*ma[6,]+3*bm*ma[7,]]))
        Wtm=np.array([R[0,]+R[3,],-R[0,]+R[1,]+R[4,],-R[1,]+R[2,]+R[5,],-R[2,]+R[6,],R[7,]-R[3,],
                      -R[7,]+R[8,]-R[4,],-R[8,]+R[9,]-R[5,],-R[9,]-R[6,]])
        ...
        # imaginary roots
        na=abs(n)
        R=np.random.normal(0,1,(4,nsim))*np.sqrt((dt/NK)*np.array([4*an*na[0,]+bn*na[1,],3*an*na[1,]+2*bn*na[2,],
                           2*an*na[2,]+3*bn*na[3,],an*na[3,]+4*bn*na[4,]]))
        Wtn=np.array([R[0,],-R[0,]+R[1,],-R[1,]+R[2,],-R[2,]+R[3],-R[3,]])
